...
public class LocationController extends BaseController {
    ...
    @Autowired
    private GenericService<Location,Integer> genericService;
    ...
    @PostMapping("/create")
    @ApiOperation("创建")
    public ApiResponse<Location> create(@RequestBody Location req) {
    ...
    @GetMapping("/{id}")
    @ApiOperation("根据ID查询")
    public ApiResponse<Location> finById(@PathVariable Integer id) {
    ...
    @ApiOperation("根据ID修改")
    public ApiResponse<Location> updateById(@RequestBody Location req) {
