 ...
 */
@Service
public class ThingandtypeServiceImpl implements GenericService<Thingandtype, String> {
//    GenericService<Thingandtype, Integer>前一个为对象，后一个为主键类型
    @Autowired
    private ThingandtypeMapper thingandtypeMapper;

    @Override
    public String create(Thingandtype thingandtype) {
        thingandtypeMapper.insertSelective(thingandtype);
        return thingandtype.getThingandtypeThingId ();
    }
    ...
    @Override
    public Thingandtype findById(String id) {
